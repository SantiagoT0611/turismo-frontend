    ...
    return [
      {
        id: 1,
        nombre: 'Amazonas',
        descripcion: 'El departamento del Amazonas se encuentra en el extremo sur de Colombia, limitando al sur con el río Amazonas y los países de Brasil y Perú, en la región conocida como la Amazonía colombiana. Su capital es Leticia, el punto principal de entrada y eje turístico de esta región selvática.',
        imagenes: [
          'https://wallpapers.com/images/featured/amazonas-8c3beryah6obx1a1.jpg',
      ...
      },
      {
        ...
        imagenes: [
          'https://tucurincaquindio.com/wp-content/uploads/2022/07/turismo-eje-cafetero.webp',
